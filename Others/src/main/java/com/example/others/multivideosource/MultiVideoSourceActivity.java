package com.example.others.multivideosource;
...
import im.zego.CustomerVideoCapture.VideoCaptureFromCamera;
import im.zego.CustomerVideoCapture.VideoCaptureFromCamera2;
import im.zego.CustomerVideoCapture.VideoCaptureFromCamera3;
import im.zego.CustomerVideoCapture.VideoCaptureFromImage;
import im.zego.CustomerVideoCapture.VideoCaptureFromImage2;
import im.zego.CustomerVideoCapture.VideoCaptureFromImage3;
import im.zego.CustomerVideoCapture.ZegoVideoCaptureCallback;
...
public class MultiVideoSourceActivity extends AppCompatActivity {
    ...
    ZegoVideoSourceType mainCurrentVideoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_NONE;
    ZegoAudioSourceType mainCurrentAudioSourceType = ZegoAudioSourceType.NONE;
    ZegoVideoSourceType auxCurrentVideoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_NONE;
...
//        if (auxCurrentAudioSourceType != ZegoAudioSourceType.INTERNAL) {
...
//        }
        ...
        mainPublishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isMainPublish){
                    ...
                    if (mainCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE) {
                    ...
                    // video source
                    if (mainCurrentVideoSourceType != ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_NONE) {
                        engine.enableCamera(true);
                    }

                    if (mainCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE) {
                        engine.startScreenCapture();
                    } else if (mainCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE) {
        ...
        auxPublishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isAuxPublish){
                    ...
                    if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE) {
                        engine.stopScreenCapture();
                    }
                    ...
                    if (isMainPublish && mainCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE &&
                            auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE) {
                    ...
                    if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_MAIN_PUBLISH_CHANNEL ||
                    ...
                    if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_MAIN_PUBLISH_CHANNEL) {
                        if (isMainPublish && mainCurrentVideoSourceType != ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_CAMERA) {
                    ...
                    // video source
                    if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_PLAYER) {
                        if (mediaPlayer == null) {
                            initMediaPlayer();
                        }
                    ...
                    if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE) {
                        engine.startScreenCapture();
                    } else if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE) {
                        engine.enableCamera(true);
                    ...
                    if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_PLAYER || auxCurrentAudioSourceType == ZegoAudioSourceType.MEDIA_PLAYER) {
        ...
        mainVideoSourceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (TextUtils.equals(getString(R.string.video_source_none), itemText)) { // none
                    videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_NONE;
                } else if (TextUtils.equals(getString(R.string.video_source_camera), itemText)) {
                    videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_CAMERA;
                } else if (TextUtils.equals(getString(R.string.video_source_screen_sharing), itemText)) {
                    videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE;
                } else { // custom capture
                    videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE;
                }
                ...
                } else if (videoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE) {
                    if (mainVideoCustomCapturer != null) {
                        mainVideoCustomCapturer.onStop(ZegoPublishChannel.MAIN);
                    }
                    mainVideoCustomCapturer = null;
        ...
        auxVideoSourceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (isMainPublish && isAuxPublish &&
                        ...
                        mainCurrentVideoSourceType != ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_CAMERA) {
                ...
                ZegoVideoSourceType videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_NONE;
                if (TextUtils.equals(getString(R.string.video_source_none), itemText)) {
                    ...
                    videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_PLAYER;
                } else if (TextUtils.equals(getString(R.string.video_source_screen_sharing), itemText)) {
                    videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE;
                } else if (TextUtils.equals(getString(R.string.video_source_main_publish_channel), itemText)) {
                    videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_MAIN_PUBLISH_CHANNEL;
                } else {
                    videoSourceType = ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE;
                }
                ...
                } else if (videoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_PLAYER) {
                    loadMediaPlayerResource();
                } else if (videoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE) {
                    if (auxVideoCustomCapturer != null) {
                        auxVideoCustomCapturer.onStop(ZegoPublishChannel.AUX);
    ...
    void mainSwitchVideoSource(ZegoVideoSourceType videoSourceType) {
        switch (mainCurrentVideoSourceType) {
            case ZEGO_VIDEO_SOURCE_SCREEN_CAPTURE:
                engine.stopScreenCapture();

                break;

            case ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE:
        ...
        if (videoSourceType != ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_NONE) {
            engine.enableCamera(true);
        }
        if (videoSourceType != ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE) {
            engine.startPreview(mainPreviewCanvas);
        }
        mainCurrentVideoSourceType = videoSourceType;
        engine.setVideoSource(mainCurrentVideoSourceType);
    ...
    void auxSwitchAudioSource(ZegoAudioSourceType audioSourceType) {
        switch (auxCurrentAudioSourceType) {
            case MEDIA_PLAYER:
                if (mediaPlayer != null && auxCurrentVideoSourceType != ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_PLAYER) {
                    mediaPlayer.pause();
                }
    ...
    boolean isMainUseCamera() {
        ...
        do {
            if (mainCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_CAMERA) {
                break;
            }

            if (mainCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE) {
                String itemText = (String) mainVideoSourceSpinner.getSelectedItem();
    ...
    boolean isAuxUseCamera() {
        ...
        do {
            if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_CAMERA) {
                break;
            }

            if (auxCurrentVideoSourceType == ZegoVideoSourceType.ZEGO_VIDEO_SOURCE_EXTERNAL_CAPTURE) {
                String itemText = (String) auxVideoSourceSpinner.getSelectedItem();
