...
import com.example.others.multivideosource.MultiVideoSourceActivity;
...
import com.example.others.superresolution.SuperResolutionActivity;
...
//        mainAdapter.addModuleInfo(new ModuleInfo().moduleName(getString(R.string.low_latency_live)));
        ...
        mainAdapter.addModuleInfo(new ModuleInfo().moduleName(getString(R.string.super_resolution)).titleName(getString(R.string.others)));
